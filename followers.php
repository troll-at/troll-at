...
<div align="center">
<span style="color:white;font-size:25px;">Followers of <a style="color: white;text-decoration-line: none;" href="profile.php?username=<?php echo $_GET['username'];?>"><?php echo $_GET['username'];?></a></span></div>
<div align="center"><h1>Numbre of followers : <?php echo $num_rows;?></h1></div><br><br>
