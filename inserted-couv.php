...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
        ...
        $line=$username."/".$lin;
    	$mysql="INSERT INTO couverture (image) VALUES ('$line')";
    	if (mysqli_query($dbconn, $mysql)) {
    		echo "
    <div style='color:white;margin-top:100px;' align='center'><h1>Congratulation your account is ready to use</h1><a href='login.php'><button style='backgound-color:green;font-size:25px;text-decoration:none;color:white;background-color:red;border:solid 1px red;'>go to your profile</button></a></div>";
