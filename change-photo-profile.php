...
<div align="center" style="color: white;margin-top: 100px;"><h1>Select your new profile photo please</h1></div>
<div align="center">
<form action="changed-profile-photo.php" enctype="multipart/form-data" method="post">
