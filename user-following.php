...
<div align="center">
<span style="color:white;font-size:25px;">Following of <a style="color: white;text-decoration-line: none;" href="profile.php?username=<?php echo $_SESSION['username'];?>"><?php echo $_SESSION['username'];?></a></span></div>
<div align="center"><h1>Numbrer of following : <?php echo $num_rows;?></h1></div><br><br>
