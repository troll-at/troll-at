...
<div align="center">
<span style="color:white;font-size:25px;">Followers of <a style="color: white;text-decoration-line: none;" href="profile.php?username=<?php echo $_SESSION['username'];?>"><?php echo $_SESSION['username'];?></a></span></div>
<div></div>
<div align="center"><h1>Numbrer of followers : <?php echo $num_rows;?></h1></div><br><br>
