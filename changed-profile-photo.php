...
if (isset($_POST['submit']))
{
  ...
  { 
    ...
    $newfilename = md5($file_basename) . $file_ext;
      ...
      $mysql="TRUNCATE TABLE image;";
      if (mysqli_query($dbconn, $mysql)) {
      	$sql="INSERT INTO image (image) VALUES ('$tar')";
      	if (mysqli_query($dbconn, $sql)) {
           echo "
    <div style='color:white;margin-top:100px;' align='center'><h1>Your profile photo has been uploaded</h1><a href='user-profile.php'><button style='backgound-color:green;font-size:25px;text-decoration:none;color:white;background-color:red;border:solid 1px red;'>go to your profile</button></a></div>";
